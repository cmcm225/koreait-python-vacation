...
# 모든 클래스의 동통 조상 -> Object 클래스
# Object를 상속 받고있다면,  Object의 메서드를 호출할 수 있다

#object 상속은 생략가능
#Person() -> __init__ 호출됨
class Person(object):
    # __어쩌고__() -> 매직메서드
    #object에 저으이되어있던 __init__() 오버드라이브하고 있었음
...
print("hi" * 3) # str클래스에서 __mul__을 오버라이딩 한거였음
print([1,2,3]+[4,5,6]) #list 틀래스에서 __add__오버라이딩
