...
print(st2.school_name) #동일한 변수 접근"만" 가능
...
# 클래스 변수 변경이 아니라
#st1에 school_name이라는 필드를 추가한것으로 파이썬이 해석
...
class Wallet:
    ...
    def take_money(self,amount):
        # 공용돈을 내 지갑에 (money필드)에 옮기는 코드를 작성
        # 남은 공용돈보다 더 많은 금액을 가져갈 순 X
        # 대소비교,동일비교->읽기
        # 객체로 접근해도 동일하게 호출
