...
class BankAccount:
    ...
    def withdraw(self, amount):
        if amount >self.balance:
            print("잔액 부족!")
            return
        # 검증 이휴에 객체에 담긴 데이터를 조작할 수 있다.
        #객체에 담긴 데이터는 언제나 신뢰가능하다.
        self.balance -=amount

acc1=BankAccount("홍길동") #홍길동 생성
acc2=BankAccount("김길동") #김길동 생성
...
# Cup 클래스
# 필드: size(최대용량), water(현재 물의 양)-생성시 0
