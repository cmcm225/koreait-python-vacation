...
# 평균점수 구하기
score_sum=0
for scores in score_nums:
    score_sum+=scores #누적합
...
for score in score_nums:
    if score >= 60:
        score_over_60.append(score)
        score_sum+=score
length_over_60=len(score_over_60)
length_over_60= score_sum/length_over_60
print(length_over_60)
