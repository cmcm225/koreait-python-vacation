...
# 실습) 한 페이지당 20개의 게시글을 볼 수 있음
#게시판의 총 게시글은 162개
#이때 총 페이지 갯수와 마지막 페이지의 게시글 수 print
total_post=162
total_page_count=total_post//20+1
last_page_post_count=total_post%20
print("총페이지:",total_page_count)
print("마지막 페이지 게시글 수:",last_page_post_count)


#비교연산자 -> 결과가 bool (True,False)
x=10
y=20
print(x == y)
print(x != y)
